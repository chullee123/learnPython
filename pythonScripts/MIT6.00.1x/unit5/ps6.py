...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        lowerVals = list(string.ascii_lowercase)
        shiftLower = lowerVals[shift:] + lowerVals[:shift]

        upperKeys = list(string.ascii_uppercase)
        upperVals = list(string.ascii_uppercase)
        shiftUpper = upperVals[shift:] + upperVals[:shift]

        allKeys = lowerKeys + upperKeys
        allVals = shiftLower + shiftUpper

        self.shiftDict = dict(zip(allKeys, allVals))
    ...
    def apply_shift(self, shift):
        ...
        for i in self.message_text:
            if i not in self.build_shift_dict(shift).keys():
                ...
                newMessage.append(self.build_shift_dict(shift)[i])
